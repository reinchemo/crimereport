...
<html lang="en">
    ...
    <style>
      ...
      .masthead{
        background: linear-gradient(to bottom, rgb(0 0 0 / 40%) 0%, rgb(245 242 240 / 45%) 100%),
      ...
      <div class="container-fluid h-100">
          <div class="row h-100 align-items-center justify-content-center text-center">
              <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">Welcome to Corruption Reporting system</h3>
               
                <img src="images/no.jpg" alt="Description of the image" style="width: 400px; height: 300px;" />


                  <hr class="divider my-4" />
              <div class="row mb-2 text-left justify-content-center ">
                 <button class="btn btn-primary" type="button" id="report_crime">Click to Report a Complain</button>
              </div>                        
              </div>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5 bg-dark">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mr-auto text-center">
                        ...
                        <a class="d-block" href="mailto:<?php echo $_SESSION['system']['email'] ?>">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 <a href="" target="_blank"></a></div></div>
        </footer>
